...
var height = 500;
var padding = 30;
// we are planning to plot lifeExpectancy on y axis - so lets scale it with ymax & ymin
// y => lifeExpectancy
// x => births/population
/*
var yMax = d3.max(birthData2011, function(d){
    return d.lifeExpectancy;
});
var yMin = d3.min(birthData2011, function(d){
    return d.lifeExpectancy;
});
*/
...
// we can also use d3.extent to get min and max values.
